...
#   sw=datalink('node1',latency=40)
  ...
  pon=datalink('pon',latency=2,ber=-12)
  ...
  onu=vswitch('onu',"","Dot1Q()",MaxSize=standardbuffers)
  olt=vswitch('olt',"Dot1Q()","",MaxSize=standardbuffers)
  cpe=vswitch('cpe',"","Dot1Q()",MaxSize=standardbuffers)
  bras=vswitch('bras',"Dot1Q()","",MaxSize=standardbuffers)
  homerouter=eth_switch('hr',MaxSize=standardbuffers)
  metrorouter=vswitch('mr',"","MPLS()",MaxSize=standardbuffers,age=10)
  corerouter=vswitch('cr',"MPLS()","",MaxSize=standardbuffers,age=10)
  connect('hostcon1',host1.B,traf.B)
  connect('hostcon2',host2.B,term2.A)
  connect('c1',homerouter.B,cpe.A)
  connect('c2',cpe.B,onu.A)
  ...
  onu=vswitch('onu',"","Dot1Q()",MaxSize=smallbuffers)
  olt=vswitch('olt',"Dot1Q()","",MaxSize=smallbuffers)
  ...
  coreswitch=eth_switch('cs',age=10)
  connect('c1',cpe.B,onu.A)
