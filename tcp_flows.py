...
#   sw=datalink('node1',capacity=1,MaxSize=10000)
  ...
  flowgen=flowgen('flowgen',start=0.002,stop=2.5,ival=0.300,flowcount=5)
  pon=datalink('pon',latency=10,ber=-12)
  link1=datalink('link1',latency=2,ber=-12)
  link2=datalink('link2',latency=2,ber=-12)
  link3=datalink('link2',latency=2,ber=-12)
  ...
  pon=datalink('pon',latency=10)
  onu=vswitch('onu',"","Dot1Q(vlan=70)")
  olt=vswitch('olt',"Dot1Q(vlan=70)","")
  cpe=eth_switch('cpe')
